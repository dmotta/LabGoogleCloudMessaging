...
import com.dmotta.gcm.labuno.deviceinfoendpoint.Deviceinfoendpoint;
import com.dmotta.gcm.labuno.deviceinfoendpoint.Deviceinfoendpoint.Builder;
import com.dmotta.gcm.labuno.deviceinfoendpoint.model.DeviceInfo;
...
public class GCMIntentService extends GCMBaseIntentService {
  ...
  public void onRegistered(Context context, String registration) {
    ...
    try {
       ...
       */
      DeviceInfo existingInfo = endpoint.device().get(registration)
          .execute();
  ...
  protected void onUnregistered(Context context, String registrationId) {
    ...
    if (registrationId != null && registrationId.length() > 0) {
      ...
      try {
        endpoint.device().remove(registrationId).execute();
      } catch (IOException e) {
        Log.e(GCMIntentService.class.getName(),
